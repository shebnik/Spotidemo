...
class NapsterService {
  ...
  static String getArtistImage(String artistId, [String size = 'medium']) {
    return 'https://api.napster.com/imageserver/v2/artists/$artistId/images/${imageSizes[size]}.jpg';
  }
  ...
  static String getTrackImage(String albumId) {
    return 'https://api.napster.com/imageserver/v2/albums/$albumId/images/170x170.jpg';
  }
